...
describe("Installation", () => {
  ...
  // Test: Check if the database migration and seeding scripts have been executed for each table
  tables.forEach((table) => {
    test(`You have executed the db:migrate and db:seed scripts for ${table} table`, async () => {
      // Query the table to check if any data has been inserted
